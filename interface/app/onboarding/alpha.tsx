...
import { TestPlatformProvider, usePlatform } from '~/util/Platform';
...
export default function OnboardingAlpha() {
	...
	return (
		<>
			<TestPlatformProvider name="AAAAA" />
			<OnboardingContainer>
				<div className="relative w-screen text-center">
					...
					<div className="relative z-10 flex flex-col gap-5">
						...
						<p className="mx-auto w-full max-w-[450px] text-sm text-ink-faint">
							We are delighted for you to try Spacedrive, now in Alpha release,
							showcasing exciting new features. As with any initial release, this
							version may contain some bugs. We kindly request your assistance in
							reporting any issues you encounter on our Discord channel. Your valuable
							feedback will greatly contribute to enhancing the user experience.
						</p>
